  ...
  return (
    <div className="space-y-3">
      ...
      {(!participantStatus || participantStatus === 'cancelled') && (
        ...
        >
          {isPending ? '처리 중...' : remainingCapacity > 0 ? '참가 신청' : '대기 신청'}
        </Button>
      )}
      ...
      {participantStatus === 'confirmed' && (
        <div className="flex flex-col gap-2 sm:flex-row">
          <span
            className="inline-flex items-center rounded-md bg-green-100 px-3 py-2 text-sm font-medium text-green-700"
      ...
      {participantStatus === 'waitlist' && (
        <div className="flex flex-col gap-2 sm:flex-row">
          <span
            className="inline-flex items-center rounded-md bg-yellow-100 px-3 py-2 text-sm font-medium text-yellow-700"
