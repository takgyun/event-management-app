...
export default async function DashboardPage() {
  ...
  const participatingEvents = participatingResult.success ? (participatingResult.data ?? []) : [];
    ...
    <div className="flex w-full items-center justify-center px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
      <div className="w-full max-w-6xl space-y-8 sm:space-y-12">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <h1 className="text-2xl font-bold sm:text-3xl md:text-4xl">대시보드</h1>
        ...
        <section className="space-y-4">
          <h2 className="text-lg font-bold sm:text-xl">내가 주최하는 이벤트</h2>
        ...
        {/* 참가 중인 이벤트 */}
        <section className="space-y-4">
          <h2 className="text-lg font-bold sm:text-xl">참가 중인 이벤트</h2>
